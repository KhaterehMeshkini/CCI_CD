...
if (__name__ == '__main__'):
    ...
    m3options['bfastpath'] = fm.formatPath(config['Paths']['bfast_path'])
    ...
    m4options['multiprocessing'] = bool(config['Module4']['multiprocessing'])
    m4options['singlefeaturedtw'] = bool(config['Module4']['singlefeaturedtw'])
    m4options['featureselection'] = bool(config['Module4']['featureselection'])
    m4options['multifeatureDTW'] = bool(config['Module4']['multifeatureDTW'])
    m4options['similarity'] = bool(config['Module4']['similarity'])
    m4options['classprototypes'] = bool(config['Module4']['classprototypes'])
